...
namespace
{
    int arr[] = 
    {
        157, 81, 77, 195, 47, 117, 122, 41, 36, 196, 64, 147, 128, 69, 46, 188, 84, 
...
int main(int argc, char** argv)
{
    ...
    sf::RenderWindow window(sf::VideoMode({800, 600}), "SortShow");
    window.setPosition({0,0});
    Renderer ren(&window);
    sort->SetRenderer(&ren);

    int size = sizeof(arr)/sizeof(arr[0]);
    ren.DrawArray(arr, size);
    ren.Display();
    Wait(1000);
